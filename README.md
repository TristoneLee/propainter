...
```shell
 ...
 python scripts/evaluate_flow_completion.py --dataset <dataset_name> --video_root datasets/davis/JPEGImages --mask_root <mask_root> --save_results
 # For evaluating ProPainter model
 python scripts/evaluate_propainter.py --dataset davis --video_root datasets/davis/JPEGImages--mask_root datasets/davis/test_masks --save_results
```
